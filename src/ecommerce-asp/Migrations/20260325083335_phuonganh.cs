...
{
    public partial class phuonganh : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Wishlists_Laptops_LaptopId",
                        column: x => x.LaptopId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Wishlists_CustomerId_LaptopId",
                table: "Wishlists",
                columns: new[] { "CustomerId", "LaptopId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Wishlists_LaptopId",
                table: "Wishlists",
                column: "LaptopId");
        }
